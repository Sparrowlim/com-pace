...
| ID | 이름 | 의존 | 상태 |
|----|------|------|------|
| [PH-00](PH-00-tooling.md) | 프로젝트 스캐폴딩 & 품질 자동화 훅 | 없음 | 상세 완료 · **착수 대상**(최우선) |
| [PH-01](PH-01-storage.md) | 데이터 모델 & 저장소 | PH-00 | 상세 완료 |
| [PH-02](PH-02-state.md) | 상태관리(Zustand slice) | PH-01 | 헤더만 |
| [PH-03](PH-03-shell.md) | 라우팅 & 앱 셸 | PH-02 | 헤더만 |
